...
> 最后更新：2026-08-25（v1.1.3.8 / vc162）
...
## 当前版本状态（2026-08-25）
- **正式版 v1.1.3.8**（versionCode 162，com.xixi.hiking，**Release+R8 签名包**）——主工程 `hiking-app3/` 即正式版，改代码直接在这里
...
## 功能清单（当前全部，v1.1.3.5）
- 📊 概览：统计卡片（总记录数/平均海拔/最高海拔/平均难度）、**难度分布柱状图（独立卡片，图标标题）**、**年度足迹热力图**（GitHub 风格，点格看当天详情：心情/天气/同行/全部照片/分享，底部「累计爬升 X 米」）
...
- ⚙️ 设置：
  ...
  - **导出**（弹窗三选一：完整含照片/纯数据/诊断报告）、**导入**；备份回忆册含心情天气同行
