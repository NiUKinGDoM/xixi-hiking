...
> 最后更新：2026-08-30（v1.1.6.10 / vc197）
...
## 当前版本状态（2026-08-30）
- **正式版 v1.1.6.10**（versionCode 197，com.xixi.hiking，**Release+R8 签名包**）——主工程 `hiking-app3/` 即正式版，改代码直接在这里
...
- 📅 计划：计划徒步管理、难度选择、完成标记（确认弹窗）、**默认按计划时间由近到远排序**、**启动提醒（系统通知，通知栏可一键「✓ 完成」/点击跳计划页，权限被拒自动降级 App 内 toast）**
