...
> 最后更新：2026-09-03（v1.1.8.9 / vc218）
...
## 当前版本状态（2026-09-03）
- **正式版 v1.1.8.9**（versionCode 218，com.xixi.hiking，**Release+R8 签名包**）——主工程 `hiking-app3/` 即正式版，改代码直接在这里
- v1.1.8.9 更新：＋添加 v3（新建空白独立行 + 下拉历史复制单选「填充」确认键 + 单选圆点）、年月/日期/心情选中态全玻璃化、弹窗文字/虚线/分割线可读性整体提升（深浅双适配）
